...
function parseConcurrencyOpts() {
  return parseCSVOpts(cmdOptions.concurrency);
}


/*
 * utility function to parse csv options
 *
 * @param {string} string in the form of
 *   a=b,c=d
 *
 * @return {obj} obj parsed into
 *   {a: b, c: d}
 */
function parseCSVOpts(csvOptsStr) {
  var splittedOpts = (csvOptsStr || '').split(',');
  var csvOpts = {};
  var opts;
